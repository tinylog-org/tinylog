...
/**
 * Policies define rollover strategies for {@link org.tinylog.writers.RollingFileWriter RollingFileWriter}.
 *
 * <p>
 * The annotation {@link org.tinylog.policies.PropertiesSupport PropertiesSupport} must be added to the implemented
 * policy class and the implemented policy must be registered as service in "META-INF/services/org.tinylog.policies" in
 * order to make the policy available by properties files and system properties.
 * </p>
 *
 * <p>
 * Example:<br>
