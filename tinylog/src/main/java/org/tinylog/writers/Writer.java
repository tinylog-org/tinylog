...
/**
 * Writers output created log entries from {@link org.tinylog.Logger Logger}.
 *
 * <p>
 * The annotation {@link org.tinylog.writers.PropertiesSupport PropertiesSupport} must be added to the implemented
 * writer class and the implemented writer must be registered as service in "META-INF/services/org.tinylog.writers" in
 * order to make the writer available by properties files and system properties.
 * </p>
 *
 * <p>
 * Example:<br>
...
public interface Writer {
	 ...
	 * registered in the <code>init()</code> method at {@link org.tinylog.writers.VMShutdownHook VMShutdownHook} for
