...
import static org.tinylog.hamcrest.CollectionMatchers.sameContent;
import static org.tinylog.hamcrest.StringMatchers.containsPattern;
...
public class LoggerTest extends AbstractTest {
	...
	public final void testOutputWithStackTraceDeep() throws InterruptedException {
		...
		Configurator.currentConfig().level("org.tinylog", null).activate();
	...
	public final void testExceptions() {
		...
		assertThat(logEntry.getRenderedLogEntry(), matchesPattern("java\\.lang\\.Exception\\: Test" + newLine
				+ "\tat org.tinylog.LoggerTest.testExceptions\\(LoggerTest.java:\\d*\\)" + newLine + "\t\\.\\.\\." + newLine));
		...
		assertThat(logEntry.getRenderedLogEntry(), containsPattern(
				"java\\.lang\\.RuntimeException.*" + newLine + "\tat org.tinylog.LoggerTest.testExceptions\\(LoggerTest.java:\\d*\\)" + newLine));
		assertThat(logEntry.getRenderedLogEntry(), containsPattern("Caused by: java\\.lang\\.NullPointerException" + newLine
				+ "\tat org.tinylog.LoggerTest.testExceptions\\(LoggerTest.java:\\d*\\)" + newLine));
	}
