...
/**
 * Tests for {@link ModernTinylogLoggerFactory}.
 */
public final class ModernTinylogLoggerFactoryTest {
	...
	public void sameLoggers() {
		ModernTinylogLoggerFactory factory = new ModernTinylogLoggerFactory();

		ModernTinylogLogger first = factory.getLogger("abc");
		assertThat(first.getName()).isEqualTo("abc");

		ModernTinylogLogger second = factory.getLogger("abc");
