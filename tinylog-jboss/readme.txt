...
--------------------------------------
   Using tinylog with JBoss Logging
--------------------------------------

tinylog's logging API can be used on any web and application server that uses
JBoss Logging as central logging engine. tinylog-jboss.jar simply forwards all
log entries to JBoss Logging and shares all MDC values.
